...
import { View, TouchableOpacity, Text, StyleSheet, PanResponder, Animated, Image } from "react-native";
...
class Ball extends Component {
  ...
  render() {
    ...
    return (
      <TouchableOpacity onPress={() => this.props.selectedImage(ball.img)}>
        <Animated.View
        style={[styles.container, animatedStyle]}
        {...this.panResponder.panHandlers}
      >
        <Image style={styles.letter} source={ball.img} />
      </Animated.View>
      </TouchableOpacity>
    );
  }
...
const styles = StyleSheet.create({
  ...
  letter:{
    width: SharedStyle.hole.width + SharedStyle.hole.borderWidth,
    height: SharedStyle.hole.height + SharedStyle.hole.borderWidth ,
  }
});
